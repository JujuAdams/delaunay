...
for( var _b = 0; _b < _border_count; _b += e_border.size )
{
	...
	var _path_nodes_count_plus_2 = _path_nodes_count + 2;
	for( var _p_offset = 0; _p_offset <= _path_nodes_count; _p_offset += 2 )
	{
		...
		{
			vertex_position( _vbuff, _x1, _y1 ); vertex_normal( _vbuff, _last_o_nx, _last_o_ny, 0 ); vertex_colour( _vbuff, merge_color( c_white, c_lime,  _p_offset    / _path_nodes_count_plus_2 ), 1 );
			vertex_position( _vbuff, _x2, _y2 ); vertex_normal( _vbuff,      _o_nx,      _o_ny, 0 ); vertex_colour( _vbuff, merge_color( c_white, c_lime, (_p_offset+2) / _path_nodes_count_plus_2 ), 1 );
			vertex_position( _vbuff, _x2, _y2 ); vertex_normal( _vbuff,      _i_nx,      _i_ny, 0 ); vertex_colour( _vbuff, merge_color( c_red  , c_lime, (_p_offset+2) / _path_nodes_count_plus_2 ), 1 );
			
			vertex_position( _vbuff, _x1, _y1 ); vertex_normal( _vbuff, _last_o_nx, _last_o_ny, 0 ); vertex_colour( _vbuff, merge_color( c_white, c_lime,  _p_offset    / _path_nodes_count_plus_2 ), 1 );
			vertex_position( _vbuff, _x1, _y1 ); vertex_normal( _vbuff, _last_i_nx, _last_i_ny, 0 ); vertex_colour( _vbuff, merge_color( c_red  , c_lime,  _p_offset    / _path_nodes_count_plus_2 ), 1 );
			vertex_position( _vbuff, _x2, _y2 ); vertex_normal( _vbuff,      _i_nx,      _i_ny, 0 ); vertex_colour( _vbuff, merge_color( c_red  , c_lime, (_p_offset+2) / _path_nodes_count_plus_2 ), 1 );
		}
		
		var _last_o_nx = _o_nx; var _last_o_ny = _o_ny;
		var _last_i_nx = _i_nx; var _last_i_ny = _i_ny;
	}
